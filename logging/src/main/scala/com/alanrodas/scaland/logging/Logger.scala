...
final class Logger private (val underlying: Underlying) {
  ...
  private var _level = LogLevel(underlying)

  def level = _level

  def level_=(level : LogLevel) {_level = level}
  // Error

  def isErrorEnabled = level.isErrorEnabled
  ...
  def isWarnEnabled = level.isWarnEnabled
  ...
  def isInfoEnabled = level.isInfoEnabled
  ...
  def isDebugEnabled = level.isDebugEnabled
  ...
  def isTraceEnabled = level.isTraceEnabled
